...
marpaWrapperBool_t  qname_1_0_isLexemeb(void *p, signed int currenti, streamIn_t *streamInp, size_t *sizelp);
marpaWrapperBool_t  qname_1_0_lexemeValuei(void *p, streamIn_t *streamInp, size_t sizel, int *valueip);
