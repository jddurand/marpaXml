...
/*************************
   Callback types
 *************************/
typedef void (*genericStack_failureCallback_t)(genericStack_error_t errorType, int errorNumber, void *failureCallbackUserDatap);
typedef int  (*genericStack_freeCallback_t)(void *elementp, void *freeCallbackUserDatap);
typedef int  (*genericStack_copyCallback_t)(void *elementDstp, void *elementSrcp, void *copyCallbackUserDatap);
...
/*************************
   Methods
 *************************/
genericStack_t *genericStack_newp(size_t elementSize, genericStack_option_t *optionp);

size_t          genericStack_pushi   (genericStack_t *genericStackp, void *elementp);
void           *genericStack_popp    (genericStack_t *genericStackp);
void           *genericStack_getp    (genericStack_t *genericStackp, unsigned int index);
size_t          genericStack_seti    (genericStack_t *genericStackp, unsigned int index, void *elementp);
size_t          genericStack_sizei   (genericStack_t *genericStackp);
